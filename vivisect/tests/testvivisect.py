...
class VivisectTest(v_t_utils.VivTest):
    ...
    def test_basic_apis(self):
        ...
        self.assertEqual(set(['Emulation Anomalies', 'EntryPoints', 'SwitchCases', 'EmucodeFunctions', 'PointersFromFile', 'FuncWrappers', 'CodeFragments', 'DynamicBranches', 'Bookmarks', 'NoReturnCalls', 'DelayImports', 'Library Loads', 'pe:ordinals', 'SwitchCases_TimedOut', 'thunk_reg', 'UnsupportedInstructions']), set(vw.getVaSetNames()))
